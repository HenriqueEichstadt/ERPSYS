...
namespace ERPSYS.MVC.Migrations
{
    ...
    [Migration("20190602225609_CriandoTabelaPessoaFisica")]
    partial class CriandoTabelaPessoaFisica
    {
            ...
            modelBuilder.Entity("ERPSYS.MVC.Models.PessoaFisica", b =>
                {
                    ...
                    b.Property<DateTime>("DataAlteracao")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 6, 2, 19, 56, 9, 611, DateTimeKind.Local).AddTicks(4052));
